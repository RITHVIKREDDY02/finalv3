...
export default function DisclaimerPage() {
  return (
    <div className="min-h-screen bg-white">
      {/* Navigation Bar */}
      <nav className="fixed top-0 left-0 right-0 z-50 px-4 py-3 bg-white border-b border-gray-200">
        <div className="max-w-4xl mx-auto flex items-center">
          <Link href="/" className="flex items-center gap-3 text-gray-800 hover:opacity-80 transition-opacity" data-testid="link-back-home">
      ...
      <div className="max-w-4xl mx-auto px-6 pt-24 pb-16">
        ...
        <div className="space-y-6 text-gray-700 leading-relaxed">
          <p>
            ...
            <a href="mailto:starletpo123@gmail.com" className="text-blue-600 hover:underline">
              starletpo123@gmail.com
            </a>
          </p>

          <h2 className="text-xl font-semibold text-gray-900 mt-8">Disclaimers for V3 Game</h2>
          <p>
          ...
          <h2 className="text-xl font-semibold text-gray-900 mt-8">Consent</h2>
          <p>
            By using our website, you hereby consent to our disclaimer and agree to its terms.
          </p>

          <h2 className="text-xl font-semibold text-gray-900 mt-8">Update</h2>
          <p>
