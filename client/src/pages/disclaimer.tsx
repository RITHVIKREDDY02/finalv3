  ...
  return (
    <div className="min-h-screen" style={{ background: 'linear-gradient(180deg, #000c1c 0%, #0a1628 50%, #000c1c 100%)' }}>
      ...
      <div className="relative pt-20 pb-16 overflow-hidden">
        <div className="absolute inset-0" style={{ background: 'radial-gradient(ellipse at 50% 0%, rgba(255,165,0,0.15) 0%, transparent 50%)' }}></div>
        <div className="absolute top-20 left-10 w-64 h-64 rounded-full opacity-20" style={{ background: 'radial-gradient(circle, #FFA500 0%, transparent 70%)', filter: 'blur(60px)' }}></div>
        <div className="absolute top-40 right-10 w-48 h-48 rounded-full opacity-15" style={{ background: 'radial-gradient(circle, #E74C3C 0%, transparent 70%)', filter: 'blur(50px)' }}></div>
        
        <div className="relative max-w-4xl mx-auto px-6 text-center pt-12">
          <div className="inline-flex items-center justify-center w-24 h-24 rounded-3xl mb-6 shadow-2xl" style={{ background: 'linear-gradient(135deg, #FFA500 0%, #FF6B35 100%)' }}>
            <Scale className="w-12 h-12 text-black" />
          </div>
          <h1 className="text-5xl md:text-6xl font-black mb-4 tracking-tight" style={{ color: '#FFA500' }}>
            Legal Disclaimer
          </h1>
      ...
      <div className="max-w-4xl mx-auto px-6 mb-12">
        <div className="relative p-6 rounded-3xl overflow-hidden" style={{ background: 'linear-gradient(135deg, rgba(255,165,0,0.15) 0%, rgba(255,107,53,0.1) 100%)', borderLeft: '4px solid #FFA500' }}>
          <div className="flex items-start gap-5">
            <div className="w-14 h-14 rounded-2xl flex items-center justify-center flex-shrink-0" style={{ background: 'linear-gradient(135deg, #FFA500, #FF6B35)' }}>
              <AlertTriangle className="w-7 h-7 text-black" />
            </div>
            <div>
              <h3 className="text-xl font-bold mb-2" style={{ color: '#FFA500' }}>Important Notice</h3>
      ...
      <div className="max-w-4xl mx-auto px-6 mb-16 space-y-6">
        ...
        <div className="p-8 rounded-3xl" style={{ background: 'rgba(231,76,60,0.08)', border: '1px solid rgba(231,76,60,0.2)' }}>
          <div className="flex items-start gap-5">
            <div className="w-12 h-12 rounded-2xl flex items-center justify-center flex-shrink-0" style={{ background: 'linear-gradient(135deg, #E74C3C, #C0392B)' }}>
              <AlertTriangle className="w-6 h-6 text-white" />
            </div>
            <div className="flex-1">
              <h3 className="text-xl font-bold mb-3" style={{ color: '#E74C3C' }}>Risk Notice</h3>
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5" style={{ background: '#E74C3C' }}>
        ...
        {/* Platform Disclaimer */}
        <div className="p-8 rounded-3xl" style={{ background: 'rgba(52,152,219,0.08)', border: '1px solid rgba(52,152,219,0.2)' }}>
          <div className="flex items-start gap-5">
            <div className="w-12 h-12 rounded-2xl flex items-center justify-center flex-shrink-0" style={{ background: 'linear-gradient(135deg, #3498DB, #2980B9)' }}>
              <Shield className="w-6 h-6 text-white" />
            </div>
            <div className="flex-1">
              <h3 className="text-xl font-bold mb-3" style={{ color: '#3498DB' }}>Platform Disclaimer</h3>
              <p className="text-base leading-relaxed" style={{ color: '#FDE4BC' }}>
        ...
        <div className="p-8 rounded-3xl" style={{ background: 'rgba(155,89,182,0.08)', border: '1px solid rgba(155,89,182,0.2)' }}>
          <div className="flex items-start gap-5">
            <div className="w-12 h-12 rounded-2xl flex items-center justify-center flex-shrink-0" style={{ background: 'linear-gradient(135deg, #9B59B6, #8E44AD)' }}>
              <Users className="w-6 h-6 text-white" />
            </div>
            <div className="flex-1">
              <h3 className="text-xl font-bold mb-3" style={{ color: '#9B59B6' }}>User Responsibility</h3>
              <p className="text-base leading-relaxed" style={{ color: '#FDE4BC' }}>
        ...
        <div className="p-8 rounded-3xl" style={{ background: 'rgba(46,204,113,0.08)', border: '1px solid rgba(46,204,113,0.2)' }}>
          <div className="flex items-start gap-5">
            <div className="w-12 h-12 rounded-2xl flex items-center justify-center flex-shrink-0" style={{ background: 'linear-gradient(135deg, #2ECC71, #27AE60)' }}>
              <FileText className="w-6 h-6 text-white" />
            </div>
            <div className="flex-1">
              <h3 className="text-xl font-bold mb-3" style={{ color: '#2ECC71' }}>Terms of Use</h3>
              <p className="text-base leading-relaxed" style={{ color: '#FDE4BC' }}>
      ...
      <div className="max-w-4xl mx-auto px-6 mb-16">
        <div className="relative p-8 rounded-3xl overflow-hidden text-center" style={{ background: 'linear-gradient(135deg, rgba(46,204,113,0.1) 0%, rgba(39,174,96,0.05) 100%)', border: '1px solid rgba(46,204,113,0.2)' }}>
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl mb-4" style={{ background: 'linear-gradient(135deg, #2ECC71, #27AE60)' }}>
            <span className="text-3xl">💡</span>
          </div>
          <h3 className="text-2xl font-bold mb-3" style={{ color: '#2ECC71' }}>Remember</h3>
