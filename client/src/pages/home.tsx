      ...
      <div className="px-6 md:px-8 lg:px-12 xl:px-16 pb-6">
        <div className="max-w-2xl mx-auto lg:max-w-7xl">
          <div className="flex flex-row gap-2 sm:gap-4 justify-center items-center">
            {/* DEMO Button */}
            <button 
              className="flex-1 px-4 sm:px-8 py-3 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-bold rounded-2xl shadow-lg transition-all duration-300 transform hover:scale-105 text-sm sm:text-base"
            ...
            {/* PROOF Button */}
            <button 
              className="flex-1 px-4 sm:px-8 py-3 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white font-bold rounded-2xl shadow-lg transition-all duration-300 transform hover:scale-105 text-sm sm:text-base"
            ...
            {/* VIP Button */}
            <button 
              className="flex-1 px-4 sm:px-8 py-3 bg-gradient-to-r from-yellow-500 to-yellow-600 hover:from-yellow-600 hover:to-yellow-700 text-white font-bold rounded-2xl shadow-lg transition-all duration-300 transform hover:scale-105 text-sm sm:text-base"
