  ...
  return (
    <div className="min-h-screen" style={{ background: 'linear-gradient(180deg, #000c1c 0%, #0a1628 50%, #000c1c 100%)' }}>
      ...
      <div className="relative pt-20 pb-16 overflow-hidden">
        <div className="absolute inset-0" style={{ background: 'radial-gradient(ellipse at 50% 0%, rgba(231,76,60,0.2) 0%, transparent 50%)' }}></div>
        <div className="absolute top-20 left-10 w-64 h-64 rounded-full opacity-20" style={{ background: 'radial-gradient(circle, #E74C3C 0%, transparent 70%)', filter: 'blur(60px)' }}></div>
        <div className="absolute top-40 right-10 w-48 h-48 rounded-full opacity-15" style={{ background: 'radial-gradient(circle, #C0392B 0%, transparent 70%)', filter: 'blur(50px)' }}></div>
        
        <div className="relative max-w-4xl mx-auto px-6 text-center pt-12">
          <div className="inline-flex items-center justify-center w-24 h-24 rounded-3xl mb-6 shadow-2xl" style={{ background: 'linear-gradient(135deg, #E74C3C 0%, #C0392B 100%)' }}>
            <ShieldAlert className="w-12 h-12 text-white" />
          </div>
          <h1 className="text-5xl md:text-6xl font-black mb-4 tracking-tight" style={{ color: '#E74C3C' }}>
            Security Warning
          </h1>
      ...
      <div className="max-w-4xl mx-auto px-6 mb-12">
        <div className="relative p-6 rounded-3xl overflow-hidden" style={{ background: 'linear-gradient(135deg, rgba(230,126,34,0.12) 0%, rgba(231,76,60,0.08) 100%)', borderLeft: '4px solid #E67E22' }}>
      ...
      {/* How We Protect You */}
      <div className="max-w-4xl mx-auto px-6 mb-12">
        <div className="p-8 rounded-3xl" style={{ background: 'rgba(46,204,113,0.08)', border: '1px solid rgba(46,204,113,0.2)' }}>
          <div className="flex items-center gap-4 mb-6">
            <div className="w-14 h-14 rounded-2xl flex items-center justify-center" style={{ background: 'linear-gradient(135deg, #2ECC71, #27AE60)' }}>
              <Lock className="w-7 h-7 text-white" />
            </div>
            <h2 className="text-2xl font-bold" style={{ color: '#2ECC71' }}>How We Protect You</h2>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-5 rounded-2xl" style={{ background: 'rgba(46,204,113,0.1)' }}>
              <div className="flex items-center gap-3 mb-3">
                <div className="w-10 h-10 rounded-full flex items-center justify-center" style={{ background: '#2ECC71' }}>
                  <CheckCircle className="w-5 h-5 text-white" />
                </div>
                <h4 className="font-bold" style={{ color: '#2ECC71' }}>API Monitoring</h4>
              </div>
            ...
            <div className="p-5 rounded-2xl" style={{ background: 'rgba(46,204,113,0.1)' }}>
              <div className="flex items-center gap-3 mb-3">
                ...
                <h4 className="font-bold" style={{ color: '#2ECC71' }}>Pattern Detection</h4>
              </div>
              <p className="text-sm" style={{ color: '#FDE4BC' }}>
            ...
            <div className="p-5 rounded-2xl" style={{ background: 'rgba(46,204,113,0.1)' }}>
              <div className="flex items-center gap-3 mb-3">
                ...
                <h4 className="font-bold" style={{ color: '#2ECC71' }}>Multi-Factor Analysis</h4>
              </div>
              <p className="text-sm" style={{ color: '#FDE4BC' }}>
            ...
            <div className="p-5 rounded-2xl" style={{ background: 'rgba(46,204,113,0.1)' }}>
              <div className="flex items-center gap-3 mb-3">
                ...
                <h4 className="font-bold" style={{ color: '#2ECC71' }}>Real-Time Updates</h4>
              </div>
              <p className="text-sm" style={{ color: '#FDE4BC' }}>
      ...
      {/* Watch Out For */}
      <div className="max-w-4xl mx-auto px-6 mb-12">
        <div className="p-8 rounded-3xl" style={{ background: 'rgba(231,76,60,0.08)', border: '1px solid rgba(231,76,60,0.2)' }}>
          <div className="flex items-center gap-4 mb-6">
            <div className="w-14 h-14 rounded-2xl flex items-center justify-center" style={{ background: 'linear-gradient(135deg, #E74C3C, #C0392B)' }}>
              <AlertOctagon className="w-7 h-7 text-white" />
            </div>
            <h2 className="text-2xl font-bold" style={{ color: '#E74C3C' }}>Potential Manipulation Tactics</h2>
          </div>
          
          <div className="space-y-4">
            <div className="p-5 rounded-2xl" style={{ background: 'rgba(231,76,60,0.1)' }}>
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0" style={{ background: '#E74C3C' }}>
                  <XCircle className="w-5 h-5 text-white" />
                </div>
                <div>
                  <h4 className="font-bold mb-2" style={{ color: '#E74C3C' }}>Controlled "Randomness"</h4>
                  <p className="text-sm" style={{ color: '#FDE4BC' }}>
            ...
            <div className="p-5 rounded-2xl" style={{ background: 'rgba(231,76,60,0.1)' }}>
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-bold mb-2" style={{ color: '#E74C3C' }}>Hidden Algorithm Changes</h4>
                  <p className="text-sm" style={{ color: '#FDE4BC' }}>
            ...
            <div className="p-5 rounded-2xl" style={{ background: 'rgba(231,76,60,0.1)' }}>
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-bold mb-2" style={{ color: '#E74C3C' }}>Selective Payout Practices</h4>
                  <p className="text-sm" style={{ color: '#FDE4BC' }}>
            ...
            <div className="p-5 rounded-2xl" style={{ background: 'rgba(231,76,60,0.1)' }}>
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-bold mb-2" style={{ color: '#E74C3C' }}>Data Manipulation</h4>
                  <p className="text-sm" style={{ color: '#FDE4BC' }}>
      ...
      {/* Stay Informed */}
      <div className="max-w-4xl mx-auto px-6 mb-12">
        <div className="p-8 rounded-3xl" style={{ background: 'rgba(155,89,182,0.08)', border: '1px solid rgba(155,89,182,0.2)' }}>
          <div className="flex items-center gap-4 mb-6">
            <div className="w-14 h-14 rounded-2xl flex items-center justify-center" style={{ background: 'linear-gradient(135deg, #9B59B6, #8E44AD)' }}>
              <Brain className="w-7 h-7 text-white" />
            </div>
            <h2 className="text-2xl font-bold" style={{ color: '#9B59B6' }}>Stay Informed, Play Smart</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 rounded-xl flex items-center gap-3" style={{ background: 'rgba(155,89,182,0.15)' }}>
              <Eye className="w-6 h-6 flex-shrink-0" style={{ color: '#9B59B6' }} />
      ...
      <div className="max-w-4xl mx-auto px-6 pb-20">
        <div className="relative p-10 rounded-3xl overflow-hidden text-center" style={{ background: 'linear-gradient(135deg, rgba(46,204,113,0.1) 0%, rgba(39,174,96,0.05) 100%)' }}>
          <div className="absolute inset-0 opacity-30" style={{ background: 'radial-gradient(circle at 70% 50%, rgba(46,204,113,0.3) 0%, transparent 50%)' }}></div>
          <div className="relative z-10">
            <h2 className="text-3xl md:text-4xl font-bold mb-4" style={{ color: '#2ECC71' }}>Ready to Play Safe?</h2>
