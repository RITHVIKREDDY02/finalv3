        ...
        <div className="flex bg-white rounded-lg p-1 max-w-md mx-auto shadow-lg">
          {variants.map((variant) => (
            <button
              ...
              style={{
                backgroundColor: activeVariant === variant.key ? '#4285f4' : 'transparent'
              }}
            >
              {variant.label}
            </button>
          ...
          <div className="p-6 text-center space-y-6">
            <div className="space-y-2">
              <h2 className="text-2xl font-bold text-white">
                🏆 TASHAN-WIN WINGO {activeVariant.toUpperCase()} 🏆
              </h2>
        ...
        <Card className="bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-700">
          ...
          <div className="p-4 space-y-4">
            ...
            <div className="space-y-2 text-gray-300 text-sm bg-black/30 p-3 rounded-lg">
              ...
              <p>⚡ Real-time predictions updated every {getIntervalSeconds(activeVariant)}s</p>
